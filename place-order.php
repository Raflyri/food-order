  ...
  <body>
      ...
      <div class="navbar-fixed">
        <nav class="navbar-color">
          <div class="nav-wrapper">
            <ul class="left">
              <li>
                <h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/Kedai-Omank2.png" alt="logo"></a> <span class="logo-text">Logo</span></h1>
              </li>
            </ul>
            <!--ul class="right hide-on-med-and-down">
              <li><a href="#" class="waves-effect waves-block waves-light"><i>RP. <?php echo $balance; ?></i></a>
              </li>
            </ul-->
          </div>
        </nav>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <select id="payment_type" name="payment_type">
                            ...
                            <option value="Card" <?php if (!$verified) echo 'enabled'; ?>>Credit / Debit Card</option>
                            <option value="Cash" <?php if (!$verified) echo 'enabled'; ?>>Cash</option>
                          </select>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="address" class="">Table Number</label>
    ...
    <footer class="page-footer">
      <div class="footer-copyright">
        <div class="container">
          <span>Copyright © 2022 <a class="grey-text text-lighten-4" href="https://www.linkedin.com/in/randyrzkiii" target="_blank">RandyRizky</a> All rights reserved.</span>
          <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="https://www.linkedin.com/in/randyrzkiii">RandyRizky</a></span>
        </div>
      </div>
    </footer>
    <!-- END FOOTER -->
